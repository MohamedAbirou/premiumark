        ...
        <div className='mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24'>
          <div className='lg:col-start-2'>
            ...
            <div className='mt-16 text-sm font-medium'>
              ...
              <div className='group flex items-center justify-end gap-x-1 mt-16 border-t border-gray-200 py-6 text-right text-blue-600 hover:text-blue-500'>
                <Link
                  href='/products'
                  className='text-sm font-medium'>
                  Continue shopping
                </Link>
                <ArrowRight className='h-4 w-4 group-hover:translate-x-2 duration-300 transition' />
              </div>
            </div>
          </div>
        </div>
